    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('specialite', EntityType::class, [
                "label" => "Pour quelle spécialité(s) êtes vous prêt à travailler",
                'class'    => PrestationType::class,
                'choice_label' => 'nom',
                'multiple' => true
            ])
            ->add('permis', CheckboxType::class, ['label' => "J'ai le permis", "required" => false])
            ->add('voiture', CheckboxType::class, ['label' => "Je dispose d'une voiture", "required" => false])
            ->add('GPS', CheckboxType::class, ['label' => "Je sais utiliser le GPS", "required" => false])
